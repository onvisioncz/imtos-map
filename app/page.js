  ...
  return (
    <div className="flex flex-col md:flex-row h-screen overflow-hidden">
      ...
      >
        ...
        <div className="h-[2px] shrink-0" style={{ background: 'linear-gradient(90deg, #D41029 0%, #ff4d5e 60%, transparent 100%)' }} />
      ...
      <aside
        className="hidden md:flex w-80 lg:w-96 shrink-0 flex-col z-10 overflow-hidden order-1"
      ...
      >
        ...
        <div className="h-[3px] w-full shrink-0" style={{ background: 'linear-gradient(90deg, #D41029 0%, #ff4d5e 60%, transparent 100%)' }} />
        ...
        <div className="px-4 py-3 flex items-center gap-2 shrink-0" style={{ borderTop: '1px solid #2e2b28' }}>
