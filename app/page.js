...
function SectionHeader({ flag, label }) {
  return (
    <div className="flex items-center gap-2.5 mb-2.5 px-2">
      {flag}
      <span className="t-mono" style={{ color: 'var(--text-low)', fontSize: 10 }}>
        {label}
      </span>
      <div className="flex-1 h-px" style={{ background: 'var(--line-dark-soft)' }} />
    </div>
  );
}
...
export default function HomePage() {
  ...
  return (
    <div className="flex flex-col md:flex-row h-screen overflow-hidden">
      ...
      >
        <div className="flex items-center gap-3 px-4 py-2.5 shrink-0" style={{ background: 'var(--bg-header)' }}>
          <ImtosLogo width={84} />
          <div className="pl-3" style={{ borderLeft: '1px solid var(--line-dark)' }}>
            <p className="t-mono" style={{ color: 'var(--text-mid)', fontSize: 9 }}>
              Mapa obchodního zastoupení
            </p>
            <p className="mt-1" style={{ color: 'var(--text-low)', fontSize: 9.5, fontWeight: 400 }}>
              Vyberte oblast svého obchodníka
            </p>
          </div>
        </div>
        <div className="h-[2px] shrink-0" style={{ background: 'var(--red)' }} />
      ...
      >
        ...
        <div className="px-7 pt-8 pb-6" style={{ background: 'var(--bg-header)' }}>
          <ImtosLogo />
          <div className="mt-5 pt-4" style={{ borderTop: '1px solid var(--line-dark)' }}>
            <p className="t-mono" style={{ color: 'var(--text-mid)', fontSize: 11 }}>
              Realizujeme vaše vize
            </p>
            <p className="mt-1.5" style={{ color: 'var(--text-low)', fontSize: 11.5, fontWeight: 400 }}>
              Mapa obchodního zastoupení
            </p>
          </div>
        </div>
        {/* Decentní červená signální linka (akcent dle brandu) */}
        <div className="h-[2px] w-full shrink-0" style={{ background: 'var(--red)' }} />
        ...
        {/* Footer */}
        <div className="px-7 py-3.5 flex items-center gap-2.5 shrink-0" style={{ borderTop: '1px solid var(--line-dark-soft)' }}>
          ...
          <p style={{ color: 'var(--text-low)', fontSize: 11.5, fontWeight: 400 }}>
